...
class ByteSize(int):
    ...
    def _validate(cls, input_value: Any, /, _: core_schema.ValidationInfo) -> ByteSize:
        ...
        try:
            ...
            raise PydanticCustomError(
                "byte_size_unit", "could not interpret byte unit: {unit}", {"unit": unit}
            )
...
class GetPydanticSchema:
    ...
    if not TYPE_CHECKING:
        ...
        def __getattr__(self, item: str) -> Any:
            ...
            if item == "__get_pydantic_json_schema__" and self.get_pydantic_json_schema:
    ...
    def _convert_schema(
        ...
        if handler is not None and original_schema["type"] == "definition-ref":
            ...
            try:
                ...
                from pydantic._internal._discriminated_union import (
