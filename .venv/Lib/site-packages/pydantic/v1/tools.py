...
__all__ = ("parse_file_as", "parse_obj_as", "parse_raw_as", "schema_json_of", "schema_of")
...
def schema_of(
    type_: Any, *, title: NameFactory | None = None, **schema_kwargs: Any
) -> "DictStrAny":
...
def schema_json_of(
    type_: Any, *, title: NameFactory | None = None, **schema_json_kwargs: Any
) -> str:
