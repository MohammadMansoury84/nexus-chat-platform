...
def generate_hash_function(frozen: bool) -> Callable[[Any], int] | None:
...
class ModelMetaclass(ABCMeta):
    ...
    def __new__(mcs, name, bases, namespace, **kwargs):  # noqa C901
        ...
        hash_func: Callable[[Any], int] | None = None
        ...
        if (namespace.get("__module__"), namespace.get("__qualname__")) != (
            ...
            for ann_name, ann_type in annotations.items():
                if is_classvar(ann_type) or is_finalvar_with_default_val(
        ...
        new_namespace = {
            ...
            "__post_root_validators__": unique_list(
                ...
                name_factory=lambda skip_on_failure_and_v: (
                    skip_on_failure_and_v[1].__name__
                ),
            ),
            "__schema_cache__": {},
    ...
    def __instancecheck__(self, instance: Any) -> bool:
        ...
        """
        return hasattr(instance, "__post_root_validators__") and super().__instancecheck__(
            instance
        )
...
class BaseModel(Representation, metaclass=ModelMetaclass):
    if TYPE_CHECKING:
        ...
        __include_fields__: ClassVar[Mapping[str, Any] | None] = None
        __exclude_fields__: ClassVar[Mapping[str, Any] | None] = None
    ...
    def __setattr__(self, name, value):  # noqa: C901 (ignore complexity)
        ...
        if not self.__config__.allow_mutation or self.__config__.frozen:
            raise TypeError(
                f'"{self.__class__.__name__}" is immutable and does not support item assignment'
            )
        if name in self.__fields__ and self.__fields__[name].final:
            raise TypeError(
    ...
    def _copy_and_set_values(
        self, values: "DictStrAny", fields_set: "SetStr", *, deep: bool
    ) -> "Self":
        if deep:
...
def create_model(
    ...
    *,
    __config__: type[BaseConfig] | None = None,
    __base__: None | type["Model"] | tuple[type["Model"], ...] = None,
    __module__: str = __name__,
    __validators__: dict[str, "AnyClassMethod"] = None,
    __cls_kwargs__: dict[str, Any] = None,
...
) -> tuple["DictStrAny", "SetStr", ValidationError | None]:
