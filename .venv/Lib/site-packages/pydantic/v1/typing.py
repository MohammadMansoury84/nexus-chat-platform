...
from typing import NotRequired as TypedDictNotRequired
from typing import Required as TypedDictRequired
...
if sys.version_info < (3, 9):
    ...
    def convert_generics(tp: type[Any]) -> type[Any]:
        ...
        if isinstance(tp, TypesUnionType):
...
if TYPE_CHECKING:
    ...
    TupleGenerator = Generator[tuple[str, Any]]
    ...
    CallableGenerator = Generator[AnyCallable]
...
def resolve_annotations(
    raw_annotations: dict[str, type[Any]], module_name: str | None
) -> dict[str, type[Any]]:
...
def get_class(type_: type[Any]) -> None | bool | type[Any]:
