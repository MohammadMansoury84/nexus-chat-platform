...
class FieldInfo(_repr.Representation):
    ...
    def __init__(self, **kwargs: Unpack[_FieldInfoInputs]) -> None:
        ...
        self._attributes_set = {
            ...
            if v is not _Unset and k not in self.metadata_lookup
        }
    ...
    def from_annotated_attribute(
        ...
        *,
        ...
        if (
            not metadata
            and isinstance(default, FieldInfo)
            and type(default) is not FieldInfo
        ):
        ...
        field_info = FieldInfo._construct(
            prepend_metadata + metadata if prepend_metadata is not None else metadata,
            **attr_overrides,
        )
        field_info._qualifiers = inspected_ann.qualifiers
        field_info._final = True
    ...
    def deprecation_message(self) -> str | None:
        ...
        return (
            self.deprecated if isinstance(self.deprecated, str) else self.deprecated.message
        )
    ...
    def __repr_args__(self) -> ReprArgs:
        ...
        for s in self.__slots__:
            ...
            if (
                ...
                or (s == "metadata" and not self.metadata)
                or (s == "repr" and self.repr is True)
            ):
                continue
            ...
            if s == "default" and self.default is not PydanticUndefined:
                ...
                yield (
                    "default_factory",
                    _repr.PlainRepr(_repr.display_as_type(self.default_factory)),
                )
            else:
    ...
    **extra: Unpack[_EmptyKwargs],
    ...
    if extra:
        warn(
            ...
            f" (Extra keys: {', '.join(k.__repr__() for k in extra)})",
            PydanticDeprecatedSince20,
            stacklevel=2,
        )
...
class ComputedFieldInfo:
    ...
    def _apply_alias_generator(
        self, alias_generator: Callable[[str], str] | AliasGenerator, name: str
    ) -> None:
