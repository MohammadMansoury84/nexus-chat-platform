...
class ModelMetaclass(ABCMeta):
    def __new__(
        ...
        **kwargs: Any,
        ...
        if bases:
            ...
            base_field_names, class_vars, base_private_attributes = mcs._collect_bases_data(
                bases
            )

            config_wrapper = ConfigWrapper.for_model(
                bases, namespace, raw_annotations, kwargs
            )
            ...
            cls.__pydantic_decorators__ = DecoratorInfos.build(
                cls, replace_wrapped_methods=True
            )
            ...
            if __pydantic_generic_metadata__:
                ...
                parent_parameters = getattr(cls, "__pydantic_generic_metadata__", {}).get(
                    "parameters", ()
                )
    ...
    def __pydantic_fields_complete__(self) -> bool:
        ...
        return (
            all(field_info._complete for field_info in field_infos.values())
            and extra_complete
        )
    ...
    * check for items which look like fields but are not (e.g. have no annotation) and warn.
    ...
    for var_name, value in list(namespace.items()):
        ...
        if isinstance(value, ModelPrivateAttr):
            ...
            if is_valid_field_name(var_name):
                raise NameError(
...
def complete_model_class(
    ...
    *,
    ...
    cls.__pydantic_serializer__ = SchemaSerializer(
        schema, core_config, _use_prebuilt=not is_force_rebuild
    )
