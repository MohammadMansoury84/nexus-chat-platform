...
from typing import TYPE_CHECKING, Any, ClassVar, Protocol, TypeAlias, TypeIs, cast
...
def is_stdlib_dataclass(cls: type[Any], /) -> TypeIs[type[StandardDataclass]]:
    ...
    """
    return "__dataclass_fields__" in cls.__dict__ and not hasattr(
...
def patch_base_fields(cls: type[Any]) -> Generator[None]:
    ...
    for base in cls.__mro__[1:]:
        dc_fields: dict[str, dataclasses.Field[Any]] = base.__dict__.get(
