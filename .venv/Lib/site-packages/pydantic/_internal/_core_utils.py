...
from typing import TYPE_CHECKING, Any, TypeGuard, Union, get_args, get_origin
...
def get_ref(s: core_schema.CoreSchema) -> str | None:
...
def _clean_schema_for_pretty_print(
    ...
    if isinstance(obj, Sequence) and not isinstance(obj, str):
        return [
            _clean_schema_for_pretty_print(v, strip_metadata=strip_metadata) for v in obj
        ]
    return obj
