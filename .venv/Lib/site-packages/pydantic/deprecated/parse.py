...
def load_str_bytes(
    ...
    *,
    ...
    warnings.warn(
        "`load_str_bytes` is deprecated.", category=PydanticDeprecatedSince20, stacklevel=2
    )
...
def load_file(
    ...
    *,
    ...
    warnings.warn(
        "`load_file` is deprecated.", category=PydanticDeprecatedSince20, stacklevel=2
    )
    path = Path(path)
    b = path.read_bytes()
