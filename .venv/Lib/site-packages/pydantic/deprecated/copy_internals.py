...
if typing.TYPE_CHECKING:
    ...
    TupleGenerator = typing.Generator[tuple[str, Any]]
...
def _iter(
    ...
    if include is not None:
        include = _utils.ValueItems.merge(
            dict.fromkeys(self.__pydantic_fields__, True), include, intersect=True
        )

    allowed_keys = _calculate_keys(
        self, include=include, exclude=exclude, exclude_unset=exclude_unset
    )  # type: ignore
...
def _get_value(
    ...
    if isinstance(v, Enum) and getattr(cls.model_config, "use_enum_values", False):
        return v.value
