...
def bool_schema(
    ...
    """
    return _dict_not_none(
        type="bool", strict=strict, ref=ref, metadata=metadata, serialization=serialization
    )
...
WithInfoWrapValidatorFunction = Callable[
    [Any, ValidatorFunctionWrapHandler, ValidationInfo[Any]], Any
]
...
def chain_schema(
    ...
    *,
    ...
    """
    return _dict_not_none(
        type="chain", steps=steps, ref=ref, metadata=metadata, serialization=serialization
    )
...
def json_schema(
    ...
    *,
    ...
    """
    return _dict_not_none(
        type="json", schema=schema, ref=ref, metadata=metadata, serialization=serialization
    )
