    ...
    class sentinel:
        ...
        *name* should be the name of the variable to which the return value
        ...
        def __init__(
            ...
            __repr: str | None = _sentinel_placeholder,
            /,
            *,
            repr: str | None = None,
...
# 3.9
    ...
    def get_origin(tp):
        ...
        if isinstance(
            tp,
            (typing._BaseGenericAlias, _types.GenericAlias, ParamSpecArgs, ParamSpecKwargs),
        ):
    ...
    class _NamedTupleMeta(type):
        def __new__(cls, typename, bases, ns):
            ...
            for key, val in ns.items():
                ...
                if key not in _special_namedtuple_fields:
...
# <=3.14
    ...
    class TypeAliasType:
        ...
        def _raise_attribute_error(self, name: str) -> Never:
            ...
            if name in {"__value__", "__type_params__", "__parameters__"}:
